            ...
            Container(
              ...
              child: TextField(
                ...
                decoration: InputDecoration(
                  contentPadding: const EdgeInsets.fromLTRB(5, 5, 0, 5),  //Meaning, Left,Top,Right,Bottom
                  hintText: hintText,
                ...
                style: TextStyle(
                    ...
                    fontSize: 14.sp),
                textInputAction: TextInputAction.search,    //After you hit search/ enter/ return on keyboard, the api is called.
                onChanged: (value){},
                onSubmitted: (value){
                  if(value.isNotEmpty){
                    //We do not make a call from the homepage
                    //if(home==false){        //Commented out these
